...
```bash
go install al.essio.dev/pkg/tools/cmd/elvoke@latest
go install al.essio.dev/pkg/tools/cmd/mcd@latest
go install al.essio.dev/pkg/tools/cmd/refiles@latest
go install al.essio.dev/pkg/tools/cmd/seq@latest
```
